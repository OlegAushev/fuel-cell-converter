...
#else
	m_channels[ADC_VOLTAGE_IN] =		Channel(ADCB_BASE, ADCBRESULT_BASE, ADC_CH_ADCIN14, ADC_SOC_NUMBER0, ADC_TRIGGER_EPWM1_SOCA);
	m_channels[ADC_VOLTAGE_OUT] =		Channel(ADCB_BASE, ADCBRESULT_BASE, ADC_CH_ADCIN2, ADC_SOC_NUMBER1, ADC_TRIGGER_EPWM1_SOCA);
	m_channels[ADC_CURRENT_IN_FIRST] =	Channel(ADCA_BASE, ADCARESULT_BASE, ADC_CH_ADCIN15, ADC_SOC_NUMBER0, ADC_TRIGGER_EPWM1_SOCA);
	m_channels[ADC_CURRENT_IN_SECOND] = 	Channel(ADCA_BASE, ADCARESULT_BASE, ADC_CH_ADCIN15, ADC_SOC_NUMBER1, ADC_TRIGGER_EPWM1_SOCB);
#endif
}
...
#else
	m_irqs[ADC_IRQ_VOLTAGE_IN] = Irq(ADCB_BASE, ADC_INT_NUMBER1, ADC_SOC_NUMBER0, INT_ADCB1);
	m_irqs[ADC_IRQ_VOLTAGE_OUT] = Irq(ADCB_BASE, ADC_INT_NUMBER2, ADC_SOC_NUMBER1, INT_ADCB2);
	m_irqs[ADC_IRQ_CURRENT_IN_FIRST] = Irq(ADCA_BASE, ADC_INT_NUMBER1, ADC_SOC_NUMBER0, INT_ADCA1);
	m_irqs[ADC_IRQ_CURRENT_IN_SECOND] = Irq(ADCA_BASE, ADC_INT_NUMBER2, ADC_SOC_NUMBER1, INT_ADCA2);
#endif
}
