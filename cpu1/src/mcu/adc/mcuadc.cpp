...
{
#ifdef CRD300
	m_channels[ADC_VOLTAGE_IN] =	Channel(ADCC_BASE, ADCCRESULT_BASE, ADC_CH_ADCIN2, ADC_SOC_NUMBER0, ADC_TRIGGER_SW_ONLY);
	m_channels[ADC_VOLTAGE_OUT] =	Channel(ADCC_BASE, ADCCRESULT_BASE, ADC_CH_ADCIN3, ADC_SOC_NUMBER1, ADC_TRIGGER_SW_ONLY);
	m_channels[ADC_CURRENT_IN] = 	Channel(ADCA_BASE, ADCARESULT_BASE, ADC_CH_ADCIN0, ADC_SOC_NUMBER0, ADC_TRIGGER_SW_ONLY);
#else
#warning "TODO"
#endif
}
...
void AdcUnit::initIRQs()
{
	...
	m_irqs[ADC_IRQ_CURRENT_IN] = Irq(ADCA_BASE, ADC_INT_NUMBER1, ADC_SOC_NUMBER0, INT_ADCA1);
#else
#warning "TODO"
#endif
}
